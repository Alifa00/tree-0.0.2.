...
private:
    struct node_t {
        ...
        bool removerec(T key) {
            ...
            if (this - > key == key) {
                if (this - > left == nullptr && this - > right !=
                    nullptr) {
                ...
                if (this - > right == nullptr && this - > left !=
                    nullptr) {
                ...
                if (this - > right != nullptr && this - > left !=
                    ...
                    return this - > right - > removerec(this - >
                                                        key);
                }
            }
            return false;
...
bool tree_t <T> ::remove(T key) {
    if (root_ != nullptr && (root_ - > left != nullptr || root_ - > right !=
                             nullptr)) {
